...
**精选 OpenClaw 技能、插件与教程，中文社区的🦞养虾指南**

[![Awesome](https://img.shields.io/badge/Awesome-🦞_OpenClaw-ff6d00?style=for-the-badge)](https://github.com/whobot-ai/awesome-openclaw-skills-zh)
[![Skills](https://img.shields.io/badge/精选技能-200%2B-0066ff?style=for-the-badge)](https://clawhub.ai)
[![ClawHub](https://img.shields.io/badge/ClawHub-13000%2B_Skills-00c853?style=for-the-badge)](https://clawhub.ai)

---

*收录优质 OpenClaw 技能、官方插件与中文教程，帮你快速找到最好用的🦞扩展。*

</div>

> **安全提醒**：ClawHub 上约 13.4% 的 Skill 存在安全问题。安装前请查看源码、验证发布者，建议使用 Skill Vetter 扫描。本列表已过滤已知恶意 Skill，但仍建议谨慎安装。
...
| OpenClaw GitHub | [github.com/openclaw](https://github.com/openclaw) |
| Skill 格式规范 | [skill-format.md](https://github.com/openclaw/clawhub/blob/main/docs/skill-format.md) |
| ClawSkills 精选目录 | [clawskills.sh](https://clawskills.sh/) |
| OpenClaw Skills 仓库 | [github.com/openclaw/skills](https://github.com/openclaw/skills) |

### 中文教程

| 教程 | 链接 |
|------|------|
| 接入微信/飞书/钉钉/QQ 教程 | [知乎](https://zhuanlan.zhihu.com/p/2013706717012186762) |
| B 站保姆级部署教程 | [Bilibili](https://www.bilibili.com/video/BV1MfFAz6EnR/) |
| 3 小时全平台教程（全 10 集） | [Bilibili](https://www.bilibili.com/video/BV1qCPCz2Eji/) |
| 1 小时全精通教程 | [Bilibili](https://www.bilibili.com/video/BV1TpAZzeEiZ/) |
| 阿里云部署指南 | [阿里云](https://developer.aliyun.com/article/1712479) |
| 阿里云喂饭级教程 | [阿里云](https://developer.aliyun.com/article/1715082) |
| 精选 2868 个 Skills 分析 | [知乎](https://zhuanlan.zhihu.com/p/2010926090475045346) |
| 52 个官方 + 5700 社区 Skill 测评 | [阿里云](https://developer.aliyun.com/article/1712680) |
| OpenClaw 工作原理详解 | [知乎](https://zhuanlan.zhihu.com/p/2002719503394567324) |
| 6 个超实用 Skills | [腾讯云](https://cloud.tencent.com/developer/article/2627617) |

### 英文教程

| 教程 | 链接 |
|------|------|
| DataCamp OpenClaw 教程 | [DataCamp](https://www.datacamp.com/tutorial/moltbot-clawdbot-tutorial) |
| DataCamp 构建自定义 Skills | [DataCamp](https://www.datacamp.com/tutorial/building-open-claw-skills) |
| DataCamp 最佳 ClawHub Skills | [DataCamp](https://www.datacamp.com/blog/best-clawhub-skills) |
| 26 工具 + 53 Skills 配置指南 | [yu-wenhao.com](https://yu-wenhao.com/en/blog/openclaw-tools-skills-tutorial/) |
| MarkTechPost WhatsApp 指南 | [MarkTechPost](https://www.marktechpost.com/2026/02/14/getting-started-with-openclaw-and-connecting-it-with-whatsapp/) |
| Signal 隐私配置指南 | [zenvanriel.com](https://zenvanriel.com/ai-engineer-blog/openclaw-signal-setup-privacy-guide/) |
| 多频道配置教程 | [LumaDock](https://lumadock.com/tutorials/openclaw-multi-channel-setup) |
| DigitalOcean Skills 介绍 | [DigitalOcean](https://www.digitalocean.com/resources/articles/what-are-openclaw-skills) |
...
1. **安装前扫描**：使用 `clawhub install skill-vetter` 安装安全扫描工具
2. **检查源码**：安装前查看 Skill 的 SKILL.md 和脚本内容
3. **验证发布者**：优先选择下载量高、有 GitHub 仓库的 Skill
4. **权限最小化**：只给 Skill 必要的环境变量和权限
5. **定期更新**：使用 `clawhub update --all` 保持 Skill 最新
6. **查看 VirusTotal 报告**：ClawHub 已集成 VirusTotal 扫描，安装前查看安全报告

> ClawHub 2026 年 1 月曾发生 "ClawHavoc" 攻击事件，1184+ 恶意 Skill 被上传。目前已集成 VirusTotal 扫描，但仍需谨慎。
...
欢迎提交 PR 补充优质 Skill！请确保：

1. Skill 有 ClawHub 页面或 GitHub 仓库（附上真实链接）
2. 提供中文描述
3. 已通过基本安全检查
4. 附上 Star 数或下载量
...
**由 [WhoBot AI](https://github.com/whobot-ai) 维护** · **[ClawHub](https://clawhub.ai)** · **[OpenClaw](https://openclaw.ai)**

持续更新中，欢迎 Star ⭐ 和贡献 PR！
